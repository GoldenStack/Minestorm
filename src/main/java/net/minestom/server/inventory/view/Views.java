...
public interface Views {
     ...
     * @param view a contiguous section of slots 0 to 26
     * @param storage {@link Barrel#VIEW} slots 0 to 26
     */
    record Barrel(@NotNull InventoryView view,
                         @NotNull InventoryView storage) implements InventoryViewImpl.ExtendableRedirect {
        public static final @NotNull InventoryView VIEW = InventoryView.contiguous(0, 26);
        public static final @NotNull InventoryView STORAGE = Barrel.VIEW.fork(0, 26);
     ...
     * @param bottles {@link BrewingStand#VIEW} slots 0 to 2
    ...
    record BrewingStand(@NotNull InventoryView view,
        ...
        public static final @NotNull InventoryView BOTTLES = BrewingStand.VIEW.fork(0, 2);
     ...
     * @param view a contiguous section of slots 0 to 26
     * @param storage {@link Chest#VIEW} slots 0 to 26
     */
    record Chest(@NotNull InventoryView view,
                        @NotNull InventoryView storage) implements InventoryViewImpl.ExtendableRedirect {
        public static final @NotNull InventoryView VIEW = InventoryView.contiguous(0, 26);
        public static final @NotNull InventoryView STORAGE = Chest.VIEW.fork(0, 26);
     ...
     * @param input {@link CraftingTable#VIEW} slots 1 to 9
     */
    record CraftingTable(@NotNull InventoryView view,
        ...
        public static final @NotNull InventoryView INPUT = CraftingTable.VIEW.fork(1, 9);
     ...
     * @param view a contiguous section of slots 0 to 8
     * @param storage {@link Dispenser#VIEW} slots 0 to 8
     */
    record Dispenser(@NotNull InventoryView view,
                            @NotNull InventoryView storage) implements InventoryViewImpl.ExtendableRedirect {
        public static final @NotNull InventoryView VIEW = InventoryView.contiguous(0, 8);
        public static final @NotNull InventoryView STORAGE = Dispenser.VIEW.fork(0, 8);
     ...
     * @param view a contiguous section of slots 0 to 53
     * @param storage {@link DoubleChest#VIEW} slots 0 to 53
     */
    record DoubleChest(@NotNull InventoryView view,
                              @NotNull InventoryView storage) implements InventoryViewImpl.ExtendableRedirect {
        public static final @NotNull InventoryView VIEW = InventoryView.contiguous(0, 53);
        public static final @NotNull InventoryView STORAGE = DoubleChest.VIEW.fork(0, 53);
     ...
     * @param view a contiguous section of slots 0 to 8
     * @param storage {@link Dropper#VIEW} slots 0 to 8
     */
    record Dropper(@NotNull InventoryView view,
                          @NotNull InventoryView storage) implements InventoryViewImpl.ExtendableRedirect {
        public static final @NotNull InventoryView VIEW = InventoryView.contiguous(0, 8);
        public static final @NotNull InventoryView STORAGE = Dropper.VIEW.fork(0, 8);
     ...
     * @param view a contiguous section of slots 0 to 1
    ...
    record EnchantingTable(@NotNull InventoryView view,
                                  ...
                                  @NotNull InventoryView.Singular fuel) implements InventoryViewImpl.ExtendableRedirect {
        public static final @NotNull InventoryView VIEW = InventoryView.contiguous(0, 1);
     ...
     * @param view a contiguous section of slots 0 to 26
     * @param storage {@link EnderChest#VIEW} slots 0 to 26
     */
    record EnderChest(@NotNull InventoryView view,
                             @NotNull InventoryView storage) implements InventoryViewImpl.ExtendableRedirect {
        public static final @NotNull InventoryView VIEW = InventoryView.contiguous(0, 26);
        public static final @NotNull InventoryView STORAGE = EnderChest.VIEW.fork(0, 26);
     ...
     * @param view a contiguous section of slots 0 to 4
     * @param storage {@link Hopper#VIEW} slots 0 to 4
     */
    record Hopper(@NotNull InventoryView view,
                         @NotNull InventoryView storage) implements InventoryViewImpl.ExtendableRedirect {
        public static final @NotNull InventoryView VIEW = InventoryView.contiguous(0, 4);
        public static final @NotNull InventoryView STORAGE = Hopper.VIEW.fork(0, 4);
     ...
     * @param view a contiguous section of slots 0 to 0
     * @param book {@link Lectern#VIEW} slots 0 to 0
     */
    record Lectern(@NotNull InventoryView view,
                          @NotNull InventoryView book) implements InventoryViewImpl.ExtendableRedirect {
        public static final @NotNull InventoryView VIEW = InventoryView.contiguous(0, 0);
        public static final @NotNull InventoryView BOOK = Lectern.VIEW.fork(0, 0);
    ...
    record Merchant(@NotNull InventoryView view,
         ...
         * @param view {@link Merchant#VIEW} slots 0 to 1
        ...
        public record Input(@NotNull InventoryView view,
            ...
            public static final @NotNull InventoryView VIEW = Merchant.VIEW.fork(0, 1);
    ...
    record Player(@NotNull InventoryView view,
         ...
         * @param hotbar {@link Contents#VIEW} slots 0 to 8
         * @param storage {@link Contents#VIEW} slots 9 to 35
         */
        public record Contents(@NotNull InventoryView view,
            ...
            public static final @NotNull InventoryView HOTBAR = Contents.VIEW.fork(0, 8);
            public static final @NotNull InventoryView STORAGE = Contents.VIEW.fork(9, 35);
        ...
        public record Crafting(@NotNull InventoryView view,
            ...
            public static final @NotNull InventoryView INPUT = Crafting.VIEW.fork(1, 4);
     ...
     * @param view a contiguous section of slots 0 to 26
     * @param storage {@link ShulkerBox#VIEW} slots 0 to 26
     */
    record ShulkerBox(@NotNull InventoryView view,
                             @NotNull InventoryView storage) implements InventoryViewImpl.ExtendableRedirect {
        public static final @NotNull InventoryView VIEW = InventoryView.contiguous(0, 26);
        public static final @NotNull InventoryView STORAGE = ShulkerBox.VIEW.fork(0, 26);
